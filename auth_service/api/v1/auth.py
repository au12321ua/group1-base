...
from auth_service.deps import get_current_user_id
...
async def get_current_user(
    ...
    data = await auth_service.get_current_user(db, user_id)
    return APIResponse(data=data)
...
async def change_password(
    ...
    await auth_service.change_password(db, user_id, request)
    return APIResponse(data=None)
